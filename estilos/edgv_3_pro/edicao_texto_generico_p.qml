...
<rule description="Texto genérico" key="{ea035f71-9110-4ede-9ffc-cfd5ddefd5cb}">
<settings calloutType="simple">
<text-style legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontItalic="0" fieldName="texto_edicao" fontWordSpacing="0" fontUnderline="0" fontFamily="Noto Sans" isExpression="0" previewBkgrdColor="255,255,255,255" useSubstitutions="0" fontSizeUnit="Point" textOrientation="horizontal" fontWeight="50" fontSize="10" allowHtml="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Regular" multilineHeight="1" fontLetterSpacing="0" fontStrikeout="0" blendMode="0" capitalization="0">
<families/>
...
<constraint notnull_strength="0" field="estilo_fonte" constraints="0" unique_strength="0" exp_strength="0"/>
...
<constraint notnull_strength="0" field="cor" constraints="0" unique_strength="0" exp_strength="0"/>
