...
<Option name="color" type="QString" value="188,60,213,255"/>
...
<rules key="{81386b2e-787a-457a-89be-0e79910e516e}">
<rule key="{30373851-547e-4356-b03c-1eea3425a0df}" filter="is_selected()">
...
<placement layerType="PointGeometry" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGenerator="" geometryGeneratorEnabled="0" lineAnchorType="0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" distUnits="MM" geometryGeneratorType="PointGeometry" quadOffset="1" overrunDistance="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="-3.0000000000000004" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetUnits="MM" offsetType="1" priority="5" dist="0" polygonPlacementFlags="2"/>
...
<alias name="" field="texto_edicao" index="1"/>
<alias name="" field="label_x" index="2"/>
<alias name="" field="label_y" index="3"/>
<alias name="" field="tamanho_txt" index="4"/>
<alias name="" field="justificativa_txt" index="5"/>
