...
<rule key="{e878ebd9-51c4-4b54-9f6a-8079156318f4}" symbol="0" filter="tipo in (2,3,4,5,6,7,9,10,11,12)" label="Tipos"/>
<rule key="{91ccac05-3804-4e98-b2bd-361f59b156b3}" symbol="1" filter="ELSE" label="Erro"/>
</rules>
<symbols>
...
<Option name="color" type="QString" value="218,114,16,255"/>
...
<rules key="{ac382dd5-28ee-4112-995b-ff8a0ca102f5}">
<rule key="{93f1f552-1080-485f-a1bd-d327c8f35699}" description="nome">
...
<rule key="{0602ce8c-f277-4e7c-8d80-11d58952458b}" description="tipo" filter="is_selected()">
<settings calloutType="simple">
...
<text-format reverseDirectionSymbol="0" wrapChar="" autoWrapLength="0" formatNumbers="0" useMaxLineLengthForAutoWrap="1" decimals="3" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" plussign="0" multilineAlign="3" addDirectionSymbol="0" placeDirectionSymbol="0"/>
<placement layerType="PointGeometry" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGenerator="" geometryGeneratorEnabled="0" lineAnchorType="0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" distUnits="MM" geometryGeneratorType="PointGeometry" quadOffset="7" overrunDistance="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="3" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetUnits="MM" offsetType="1" priority="5" dist="0" polygonPlacementFlags="2"/>
<rendering scaleVisibility="0" displayAll="0" drawLabels="1" mergeLines="0" zIndex="0" fontMaxPixelSize="10000" scaleMin="0" maxNumLabels="2000" unplacedVisibility="0" fontMinPixelSize="3" limitNumLabels="0" obstacleFactor="1" fontLimitPixelSize="0" upsidedownLabels="0" scaleMax="0" labelPerPart="0" obstacleType="1" obstacle="1" minFeatureSize="0"/>
<dd_properties>
<Option type="Map">
<Option name="name" type="QString" value=""/>
...
<Option name="Praia (12)" type="QString" value="12"/>
</Option>
</Option>
</config>
</editWidget>
...
<alias name="" field="espacamento" index="8"/>
...
<constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="espacamento"/>
