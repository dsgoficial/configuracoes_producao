...
<rule key="{0d81ec92-b3a3-432d-9fc4-d6e4edfa026a}" symbol="0" filter="tipo in ( 1,2,3,6,8,9,10,11,12,18,19)"/>
<rule key="{73e96dc4-82c4-4563-bbe5-c180e3ccb30f}" symbol="1" filter="ELSE" label="Erro"/>
</rules>
<symbols>
...
<Option name="outline_color" type="QString" value="255,147,22,255"/>
...
<prop k="outline_color" v="255,147,22,255"/>
...
<rules key="{57435c07-215e-41eb-a70f-8279bd0f3ae8}">
<rule key="{8b2b4bfd-3a07-4bf3-a2ca-dcbc83dc69b6}" filter="is_selected()">
...
<placement layerType="PointGeometry" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGenerator="" geometryGeneratorEnabled="0" lineAnchorType="0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" distUnits="MM" geometryGeneratorType="PointGeometry" quadOffset="1" overrunDistance="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="-5" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetUnits="MM" offsetType="1" priority="5" dist="0" polygonPlacementFlags="2"/>
...
<rule key="{a131aaea-c200-407b-a5ea-d3d360649bbd}" filter="is_selected()">
<settings calloutType="simple">
...
<alias name="" field="justificativa_txt" index="6"/>
<alias name="" field="simb_rot" index="7"/>
