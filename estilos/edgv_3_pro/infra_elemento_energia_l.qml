...
<rule filter="ELSE" symbol="0" key="{38cdbd8e-f746-40df-98da-0ecf746da3bd}"/>
<rule filter="&quot;tipo&quot; in (302,303)" label="L10115A" symbol="1" key="{0555275e-d552-4cb7-93e2-98770713f942}"/>
</rule>
</rules>
<symbols>
...
<text-style legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontItalic="0" fieldName="nome" fontWordSpacing="0" fontUnderline="0" fontFamily="Arial" isExpression="0" previewBkgrdColor="255,255,255,255" useSubstitutions="0" fontSizeUnit="Point" textOrientation="horizontal" fontWeight="50" fontSize="6" allowHtml="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Regular" multilineHeight="1" fontLetterSpacing="0" fontStrikeout="0" blendMode="0" capitalization="0">
<families/>
...
<text-mask maskEnabled="0" maskOpacity="1" maskType="0" maskSizeUnits="MM" maskJoinStyle="128" maskSize="1.5" maskedSymbolLayers="" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
...
<placement overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" lineAnchorClipping="0" xOffset="0" centroidInside="0" maxCurvedCharAngleIn="25" overrunDistance="0" placementFlags="10" dist="0" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" quadOffset="4" rotationUnit="AngleDegrees" geometryGenerator="" rotationAngle="0" priority="5" fitInPolygonOnly="0" preserveRotation="1" geometryGeneratorEnabled="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="2" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" repeatDistanceUnits="MM" lineAnchorPercent="0.5" layerType="LineGeometry" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" offsetType="0" lineAnchorType="0" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0"/>
