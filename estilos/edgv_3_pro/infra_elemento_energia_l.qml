...
<rules key="{d7ebc204-cd3e-42f3-ac6b-2a73283d6152}">
<rule key="{c878344c-323e-43f0-8f93-d82b4f20155a}" filter="is_selected()">
...
<rule key="{6f7f641f-f3af-4cc2-8930-88ce6a7fdb54}" filter="is_selected()">
<settings calloutType="simple">
...
<alias name="" field="length_otf" index="11"/>
</aliases>
<defaults>
