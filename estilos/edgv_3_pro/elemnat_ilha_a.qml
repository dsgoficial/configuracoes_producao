...
<rules key="{83eb1b87-fa95-41a9-aa10-0b0e8a1ca992}">
<rule filter="visivel = 1" key="{328c5cfc-1905-45ff-b69c-c4512dd6e828}">
...
<Option type="QString" value="1" name="Fluvial (1)"/>
<Option type="QString" value="3" name="Lacustre (3)"/>
<Option type="QString" value="2" name="Marítima (2)"/>
</Option>
</Option>
</config>
</editWidget>
