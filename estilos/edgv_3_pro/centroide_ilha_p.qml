...
<rule key="{a2d461ce-519b-496c-bf59-090c5dc58945}" symbol="0" filter="tipo in(1,2,3)"/>
<rule key="{81c7d092-328d-4a02-bd50-bd60199f2bf4}" symbol="1" filter="ELSE" label="Erro"/>
</rules>
<symbols>
...
<Option name="color" type="QString" value="214,242,0,255"/>
...
<rules key="{9e47b042-eee9-4016-8874-a3e4bfbdad7b}">
<rule key="{7ca42055-04d6-4454-8cf4-0034647f48c3}" filter="is_selected()">
...
<placement layerType="PointGeometry" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGenerator="" geometryGeneratorEnabled="0" lineAnchorType="0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" distUnits="MM" geometryGeneratorType="PointGeometry" quadOffset="7" overrunDistance="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="4.0000000000000018" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetUnits="MM" offsetType="1" priority="5" dist="0" polygonPlacementFlags="2"/>
...
<rule key="{7bdd438a-0519-4215-a94a-a52995234409}" filter="is_selected()">
<settings calloutType="simple">
...
<text-format reverseDirectionSymbol="0" wrapChar="" autoWrapLength="0" formatNumbers="0" useMaxLineLengthForAutoWrap="1" decimals="3" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" plussign="0" multilineAlign="3" addDirectionSymbol="0" placeDirectionSymbol="0"/>
<placement layerType="PointGeometry" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGenerator="" geometryGeneratorEnabled="0" lineAnchorType="0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" distUnits="MM" geometryGeneratorType="PointGeometry" quadOffset="1" overrunDistance="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="-4.0000000000000018" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetUnits="MM" offsetType="1" priority="5" dist="0" polygonPlacementFlags="2"/>
<rendering scaleVisibility="0" displayAll="0" drawLabels="1" mergeLines="0" zIndex="0" fontMaxPixelSize="10000" scaleMin="0" maxNumLabels="2000" unplacedVisibility="0" fontMinPixelSize="3" limitNumLabels="0" obstacleFactor="1" fontLimitPixelSize="0" upsidedownLabels="0" scaleMax="0" labelPerPart="0" obstacleType="1" obstacle="1" minFeatureSize="0"/>
<dd_properties>
<Option type="Map">
<Option name="name" type="QString" value=""/>
...
<alias name="" field="operador_criacao" index="4"/>
<alias name="" field="data_criacao" index="5"/>
<alias name="" field="operador_atualizacao" index="6"/>
<alias name="" field="data_atualizacao" index="7"/>
</aliases>
<defaults>
