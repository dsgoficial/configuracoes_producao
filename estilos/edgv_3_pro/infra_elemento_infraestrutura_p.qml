...
<rule key="{9079df56-499e-4fa9-a0b1-85debace6774}" symbol="0"/>
</rules>
<symbols>
...
<Option name="color" type="QString" value="0,214,203,255"/>
...
<rules key="{99c716ab-7e76-446d-87b7-eb45fc24b853}">
<rule key="{6fe7ac39-3d2e-4392-85ba-e47f3e23b29a}" filter="is_selected()">
...
<rule key="{04b87b4f-bee3-4e77-8003-e36a34155308}" filter="is_selected()">
<settings calloutType="simple">
...
<Option name="Antena de comunicação (1301)" type="QString" value="1301"/>
...
<Option name="Girador Ferroviário (1701)" type="QString" value="1701"/>
...
<Option name="Torre de comunicação (1201)" type="QString" value="1201"/>
</Option>
</Option>
</config>
</editWidget>
