...
<rule key="{c939e211-e63f-479a-aa99-2b2fa2349f34}" symbol="0"/>
<rule key="{c875baa9-99fd-411c-85a0-c3604f0fb7b9}" checkstate="0" symbol="1" label="Vértices"/>
</rules>
<symbols>
...
<rules key="{236eaffe-0e94-4080-a25d-380a9a71005b}">
<rule key="{d1bf0e1d-69c4-48f7-bf28-29cec1f72416}" filter="is_selected()">
...
<rule key="{93db37ad-f800-426a-b2ff-4c5c915f07e8}" filter="is_selected()">
<settings calloutType="simple">
...
<text-format reverseDirectionSymbol="0" wrapChar="" autoWrapLength="0" formatNumbers="0" useMaxLineLengthForAutoWrap="1" decimals="3" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" plussign="0" multilineAlign="3" addDirectionSymbol="0" placeDirectionSymbol="0"/>
<placement layerType="PolygonGeometry" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGenerator="" geometryGeneratorEnabled="0" lineAnchorType="0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" distUnits="MM" geometryGeneratorType="PointGeometry" quadOffset="1" overrunDistance="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="-2.0000000000000009" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetUnits="MM" offsetType="0" priority="5" dist="0" polygonPlacementFlags="2"/>
<rendering scaleVisibility="0" displayAll="0" drawLabels="1" mergeLines="0" zIndex="0" fontMaxPixelSize="10000" scaleMin="0" maxNumLabels="2000" unplacedVisibility="0" fontMinPixelSize="3" limitNumLabels="0" obstacleFactor="1" fontLimitPixelSize="0" upsidedownLabels="0" scaleMax="0" labelPerPart="0" obstacleType="1" obstacle="1" minFeatureSize="0"/>
<dd_properties>
<Option type="Map">
<Option name="name" type="QString" value=""/>
...
<Option name="Estação geradora – Maré-motriz (407)" type="QString" value="407"/>
...
<Option name="Subestação de distribuição de energia elétrica (1802)" type="QString" value="1802"/>
<Option name="Subestação de transmissão de energia elétrica (1801)" type="QString" value="1801"/>
</Option>
</Option>
</config>
</editWidget>
