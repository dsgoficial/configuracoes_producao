...
<rule symbol="0" filter="tipo in (6,8,12,14,15,16,17,18,19)" key="{b33d0f59-d48c-484b-9851-4a510c30b9cc}" label="Ok"/>
<rule symbol="1" filter="ELSE" key="{c8471eb4-3f1a-4365-8ba8-556cd4eff924}" label="Erro"/>
</rules>
<symbols>
...
<Option value="0,255,145,255" name="color" type="QString"/>
...
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="PointGeometry" yOffset="-4.0000000000000018" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="0" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="1" placement="1" offsetType="1" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
...
<alias field="attribute_error_description" name="" index="8"/>
</aliases>
<defaults>
