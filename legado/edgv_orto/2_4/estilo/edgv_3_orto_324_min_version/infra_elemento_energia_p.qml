...
<rule symbol="0" filter="tipo in (405, 406, 407, 408, 409, 498, 1801, 1802)" key="{250275a8-67a0-4aae-9c53-faa3ff75c440}" label="Ok"/>
<rule symbol="1" filter="ELSE" key="{1d2eed81-1229-47e7-93a4-4ae6bf583f7c}" label="Erro"/>
</rules>
<symbols>
...
<rules key="{59dfb5ce-5c4a-4dc2-ba76-7f682661d53e}">
<rule filter="is_selected()" key="{800f86b8-0b62-4370-bd98-84dac8daf690}">
...
<rule filter="is_selected()" key="{3a40b6a8-997e-46b0-8ec6-1b87f218d2f0}">
<settings calloutType="simple">
