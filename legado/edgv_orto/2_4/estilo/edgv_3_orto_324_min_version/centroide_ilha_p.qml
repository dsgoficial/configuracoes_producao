...
<rule symbol="0" filter="tipo in (1,2,3)" key="{a2d461ce-519b-496c-bf59-090c5dc58945}" label="Ok"/>
<rule symbol="1" filter="ELSE" key="{81c7d092-328d-4a02-bd50-bd60199f2bf4}" label="Erro"/>
</rules>
<symbols>
