...
<rules key="{68da1dbd-e501-4358-bf43-74d3d5af8848}">
<rule key="{dcbef6d0-dab9-4f22-9fb2-5cc1f189ec5f}" filter="is_selected()">
...
<rule key="{9c3b3cfc-fee8-4307-a216-a389e4bb88fa}" filter="is_selected()">
<settings calloutType="simple">
