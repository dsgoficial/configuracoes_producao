...
<rule key="{46908b53-de7d-48ae-b6b2-3c6cbb327483}" symbol="0"/>
<rule key="{c321846f-4705-4dd0-ae21-804585175bde}" symbol="1" label="Vértices"/>
</rules>
<symbols>
...
<rules key="{f46fa4b7-bc07-49f5-8ac2-20d2adfd643a}">
<rule key="{34b71dd3-94ba-4639-95b2-40107cea3258}" filter="is_selected()">
...
<placement layerType="PolygonGeometry" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" geometryGenerator="" geometryGeneratorEnabled="0" lineAnchorType="0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" distUnits="MM" geometryGeneratorType="PointGeometry" quadOffset="4" overrunDistance="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetUnits="MM" offsetType="0" priority="5" dist="0" polygonPlacementFlags="2"/>
...
<rule key="{996ecd49-6370-4053-b7dd-0841f01616d8}" filter="is_selected()">
<settings calloutType="simple">
...
<alias name="" field="exibir_linha_rotulo" index="12"/>
<alias name="" field="observacao" index="13"/>
<alias name="" field="operador_criacao" index="14"/>
<alias name="" field="data_criacao" index="15"/>
<alias name="" field="operador_atualizacao" index="16"/>
<alias name="" field="data_atualizacao" index="17"/>
