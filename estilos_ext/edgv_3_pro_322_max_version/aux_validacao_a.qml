...
<alias name="" field="area_otf" index="8"/>
</aliases>
<defaults>
...
<column hidden="0" name="descricao" type="field" width="-1"/>
<column hidden="0" name="subfase_id" type="field" width="-1"/>
