...
<rule key="{f4b822b6-e96e-4bd4-8776-c4db8e00ccda}" symbol="0" filter="tipo in (1,2)"/>
<rule key="{8bf8b461-75b7-4dc4-b952-c8a73e55823b}" symbol="1" filter="ELSE" label="ERRO"/>
</rule>
<rule key="{5d5048a6-8810-403c-9b1e-dc9e1df54ce5}" checkstate="0" symbol="2"/>
</rules>
<symbols>
...
<Option name="line_color" type="QString" value="2,2,2,255"/>
...
<rules key="{02f70fdc-f735-486d-8a4c-9cc798e7b672}">
<rule key="{7bf8faa1-6a84-4f2a-9b16-343495f0f9f5}" filter="is_selected()">
...
<rule key="{b26d5d37-a925-4896-94e3-9e75bc50e809}" filter="is_selected()">
<settings calloutType="simple">
...
<Option name="Bote transportador (2)" type="QString" value="2"/>
</Option>
</Option>
</config>
</editWidget>
