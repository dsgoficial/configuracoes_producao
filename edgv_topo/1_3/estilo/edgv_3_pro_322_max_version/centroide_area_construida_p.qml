...
<Option name="color" type="QString" value="88,0,220,255"/>
...
<rules key="{3404234d-f533-4af3-b47d-0a171c87ab67}">
<rule key="{70a6da42-805b-4ce0-95f7-f18a6c3b6d5b}" filter="is_selected()">
...
<placement layerType="PointGeometry" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="6" geometryGenerator="" geometryGeneratorEnabled="0" lineAnchorType="0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" distUnits="MM" geometryGeneratorType="PointGeometry" quadOffset="4" overrunDistance="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetUnits="MM" offsetType="1" priority="5" dist="0" polygonPlacementFlags="2"/>
...
<column hidden="0" name="densamente_edificada" type="field" width="-1"/>
<column hidden="0" name="assentamento_precario" type="field" width="-1"/>
...
<labelOnTop>
<field labelOnTop="0" name="assentamento_precario"/>
<field labelOnTop="0" name="data_atualizacao"/>
<field labelOnTop="0" name="data_criacao"/>
<field labelOnTop="0" name="densamente_edificada"/>
...
<reuseLastValue>
<field name="assentamento_precario" reuseLastValue="0"/>
<field name="data_atualizacao" reuseLastValue="0"/>
<field name="data_criacao" reuseLastValue="0"/>
<field name="densamente_edificada" reuseLastValue="0"/>
