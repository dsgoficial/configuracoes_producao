# EDGV 3.0 Topo 1.4: Models QGIS Via Deslocamento
...
### 3. Identificar erros de atributação
...
### 4. Identificar erros de ortografia no atributo nome
...
- arquivo: /configuracoes_producao/edgv_topo/1_4/modelo_qgis/via_deslocamento/identifica_rodovias_entrelacadas.model3
...
- arquivo: /configuracoes_producao/edgv_topo/1_4/modelo_qgis/infra_ferrovia/snap_hierarquico_ferrovia.model3
- processos utilizados: Snap Hierárquico
- configuração do snap hierárquico: /configuracoes_producao/edgv_topo/1_4/modelo_qgis/snap_hierarquico_via_deslocamento.json
...
- camadas linha: infra_ferrovia_l, moldura
...
### 19. Identificar erros na rede ferroviaria

- arquivo: /configuracoes_producao/edgv_topo/1_4/modelo_qgis/infra_ferrovia/identificar_erros_rede_ferrovia
- camadas: infra_ferrovia_l, moldura
- camada de moldura: aux_moldura_area_continua_a | aux_moldura_a | moldura
- black list de atributos: ["id","texto_edicao","label_x","label_y","justificativa_txt","tamanho_txt","visivel","carta_simbolizacao","simbolizar_carta_mini","simb_rot","rotular_carta_mini","espacamento","tamanho_txt","estilo_fonte","cor","cor_buffer","tamanho_buffer","observacao","length_otf", "geometry_error", "observacao", "operador_criacao", "data_criacao", "operador_atualizacao", "data_atualizacao"]
...
- arquivo: /configuracoes_producao/edgv_topo/1_4/modelo_qgis/infra_ferrovia/identificar_pontas_soltas_pequenas_ferrovia.model3
