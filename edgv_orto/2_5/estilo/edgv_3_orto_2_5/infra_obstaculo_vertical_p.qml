...
<qgis labelsEnabled="1" version="3.40.2-Bratislava" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{2afd3fff-113b-4205-ba47-78949d916e50}">
      <rule filter="not(9999 in (tipo))" label="Ok" key="{9079df56-499e-4fa9-a0b1-85debace6774}" symbol="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" is_animated="0" name="0" frame_rate="10" force_rhr="0">
        ...
        <layer enabled="1" id="{2a611560-d8e4-4c6f-8d4c-3fb2c8bb2853}" pass="0" class="SimpleMarker" locked="0">
          <Option type="Map">
            ...
            <Option value="207,0,214,255,hsv:0.82825000000000004,1,0.83921568627450982,1" type="QString" name="color"/>
        ...
        <layer enabled="1" id="{69fbc517-0f2a-4a47-a4c1-c9d55ee7587c}" pass="0" class="SimpleMarker" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="0,0,0,255,hsv:0.82825000000000004,1,0,1" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="circle" type="QString" name="name"/>
            <Option value="0,0" type="QString" name="offset"/>
  ...
  <labeling type="rule-based">
    <rules key="{cb943944-f995-464d-bd60-49af81d6d46d}">
      <rule filter="is_selected()" key="{0f6a5215-fb81-4953-9547-b4d06c3fd140}">
        <settings calloutType="simple">
          <text-style multilineHeight="1" fontLetterSpacing="0" capitalization="0" fieldName="'Altitude: ' + to_string(altitude) +  '\n' + 'Altura: ' + to_string(altura)" allowHtml="0" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" fontWeight="50" tabStopDistanceUnit="Point" isExpression="1" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" forcedItalic="0" blendMode="0" textOpacity="1" fontSizeUnit="Point" forcedBold="0" textOrientation="horizontal" tabStopDistance="80" fontFamily="Arial" legendString="Aa" fontKerning="1" fontItalic="0" fontSize="12" textColor="50,50,50,255,rgb:0.19607843137254902,0.19607843137254902,0.19607843137254902,1" fontStrikeout="0" namedStyle="Normal" multilineHeightUnit="Percentage">
            <families/>
