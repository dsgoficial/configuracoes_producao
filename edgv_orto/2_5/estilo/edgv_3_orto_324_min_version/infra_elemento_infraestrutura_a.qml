...
<rule symbol="1" checkstate="0" key="{b0bcdd9f-232d-4a49-92f3-f815516cc810}" label="Vértices"/>
</rules>
<symbols>
<symbol clip_to_extent="1" alpha="0.581" force_rhr="0" name="0" type="fill">
...
<prop v="bevel" k="joinstyle"/>
<prop v="255,253,255,255" k="line_color"/>
...
<rule filter="is_selected()" key="{ec4051be-29ba-4b87-a9ca-e8fde4ddeb1c}">
...
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="PolygonGeometry" yOffset="1.9000000000000006" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="0" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="7" placement="1" offsetType="0" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
...
<rule filter="is_selected()" key="{abd7be79-c565-4e6b-b231-3c873baf92dd}">
<settings calloutType="simple">
...
<Option value="1938" name="Atrac - Cais (1938)" type="int"/>
<Option value="1939" name="Atrac - Cais flutuante (1939)" type="int"/>
<Option value="1944" name="Atrac - Desembarcadouro (1944)" type="int"/>
<Option value="1943" name="Atrac - Dolfim (1943)" type="int"/>
<Option value="1941" name="Atrac - Molhe de atracação (1941)" type="int"/>
<Option value="1942" name="Atrac - Pier (1942)" type="int"/>
<Option value="1940" name="Atrac - Trapiche (1940)" type="int"/>
</Option>
</Option>
</config>
</editWidget>
...
<alias field="justificativa_txt" name="" index="7"/>
...
<alias field="attribute_error_description" name="" index="15"/>
</aliases>
<defaults>
...
<style background_color="#ff7f7f" background_color_alpha="255" rule="(tipo %100) in (95, 98) and (observacao is NULL or observacao = '')" name="tipo - Atributo Misto e Outros devem ser indicados no atributo observacao (R63_V)">
<font style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
</style>
<style background_color="#ffff7f" background_color_alpha="255" rule="((tipo - tipo %100)/100) in (7, 8, 10, 13, 14, 15, 16, 17, 18, 20) or tipo in (1938, 1939, 1940, 1941, 1943, 1944)" name="tipo - Incomum, confirmar atributação (R77_A)">
<font style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
</style>
