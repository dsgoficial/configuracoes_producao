...
<rule symbol="0" filter="tipo in (1, 2, 12)" key="{275f6a37-34e1-422a-9adc-14acdcad793b}" label="Ok"/>
<rule symbol="1" filter="ELSE" key="{6a4ec4eb-16b7-4aef-9c0e-bc381b8800e7}" label="Erro"/>
<rule symbol="2" checkstate="0" key="{ab8dd470-19fd-4f5e-b0b3-3654b336d2f5}" label="Vértices"/>
</rules>
<symbols>
...
<prop v="229,127,54,255" k="line_color"/>
...
<prop v="0" k="draw_inside_polygon"/>
<prop v="bevel" k="joinstyle"/>
<prop v="18,152,127,255" k="line_color"/>
<prop v="solid" k="line_style"/>
...
<symbol clip_to_extent="1" alpha="1" force_rhr="0" name="@2@0" type="marker">
<data_defined_properties>
<Option type="Map">
<Option value="" name="name" type="QString"/>
<Option name="properties"/>
...
<rules key="{f18870ba-d217-4b41-9246-da92e2c57df8}">
<rule description="nome " filter="is_selected()" key="{67ac6483-fa16-4dba-ac6c-2487ffbcaa74}">
...
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="LineGeometry" yOffset="-3" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="2" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="1" placement="2" offsetType="1" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
...
<rule description="Tipo" filter="is_selected()" key="{8a4c4177-f681-4403-90aa-d2748817268e}">
<settings calloutType="simple">
<text-style multilineHeight="1" textOpacity="1" textColor="50,50,50,255" fontFamily="Liberation Sans" fontLetterSpacing="0" fontUnderline="0" fontWordSpacing="0" fontItalic="0" previewBkgrdColor="255,255,255,255" legendString="Aa" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="12" fontSizeUnit="Point" allowHtml="0" fieldName="regexp_replace(represent_value(&quot;tipo&quot;, 'tipo'), ' \\(\\d*\\)', '')" fontWeight="50" isExpression="1" fontKerning="1" textOrientation="horizontal" fontStrikeout="0" blendMode="0" namedStyle="Regular" capitalization="0">
<families/>
<text-buffer bufferNoFill="1" bufferSize="1" bufferDraw="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferOpacity="1" bufferJoinStyle="128" bufferColor="250,250,250,255"/>
<text-mask maskSize="0" maskSizeUnits="MM" maskedSymbolLayers="" maskEnabled="0" maskJoinStyle="128" maskOpacity="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
<background shapeSVGFile="" shapeSizeY="0" shapeOffsetY="0" shapeBorderColor="128,128,128,255" shapeRadiiX="0" shapeRadiiUnit="Point" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeBlendMode="0" shapeRadiiY="0" shapeOffsetX="0" shapeBorderWidth="0" shapeSizeX="0" shapeOffsetUnit="Point" shapeBorderWidthUnit="Point" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeRotation="0" shapeRotationType="0" shapeFillColor="255,255,255,255" shapeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="Point" shapeOpacity="1">
...
<text-format rightDirectionSymbol=">" reverseDirectionSymbol="0" addDirectionSymbol="0" formatNumbers="0" autoWrapLength="0" leftDirectionSymbol="&lt;" multilineAlign="0" plussign="0" decimals="3" wrapChar="" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0"/>
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="LineGeometry" yOffset="3" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="2" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="12" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="7" placement="2" offsetType="1" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
<rendering minFeatureSize="0" zIndex="0" scaleMin="0" obstacleFactor="1" limitNumLabels="0" upsidedownLabels="0" maxNumLabels="2000" drawLabels="1" displayAll="0" unplacedVisibility="0" mergeLines="0" fontMinPixelSize="3" obstacleType="1" labelPerPart="0" obstacle="1" fontLimitPixelSize="0" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="0"/>
<dd_properties>
<Option type="Map">
<Option value="" name="name" type="QString"/>
...
<Option value="2" name="Morro (2)" type="int"/>
<Option value="12" name="Praia (12)" type="int"/>
<Option value="1" name="Serra (1)" type="int"/>
</Option>
</Option>
</config>
</editWidget>
...
<alias field="texto_edicao" name="" index="3"/>
<alias field="tamanho_txt" name="" index="4"/>
<alias field="espacamento" name="" index="5"/>
<alias field="visivel" name="" index="6"/>
<alias field="observacao" name="" index="7"/>
<alias field="operador_criacao" name="" index="8"/>
<alias field="data_criacao" name="" index="9"/>
<alias field="operador_atualizacao" name="" index="10"/>
<alias field="data_atualizacao" name="" index="11"/>
<alias field="length_otf" name="" index="12"/>
<alias field="attribute_error_description" name="" index="13"/>
</aliases>
<defaults>
...
<constraint field="espacamento" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
...
<constraint field="espacamento" desc="" exp=""/>
...
<column hidden="0" name="espacamento" type="field" width="-1"/>
...
<style background_color="#ffff7f" background_color_alpha="255" rule="tipo in (4, 5, 6, 7, 9, 10, 11)" name="tipo - Incomum, confirmar atributação (R69_A)">
...
<style background_color="#ff7f7f" background_color_alpha="255" rule="nome is null" name="nome - todas feições dessa classe necessitam de nome (R4_V)">
<font style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
</style>
</fieldstyle>
</fieldstyles>
