...
<rule symbol="0" filter="tipo in (2, 3, 4, 5, 6, 7, 9, 10, 11, 12, 17)" key="{e878ebd9-51c4-4b54-9f6a-8079156318f4}" label="Ok"/>
<rule symbol="1" filter="ELSE" key="{91ccac05-3804-4e98-b2bd-361f59b156b3}" label="Erro"/>
</rules>
<symbols>
...
<rules key="{8dbb9a5d-a884-4e46-850e-dc00b7c81ad7}">
<rule description="nome" key="{993f4de4-a3d0-4dda-a2f8-88f272c5ed4f}">
...
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="PointGeometry" yOffset="-3" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="0" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="1" placement="1" offsetType="1" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
...
<rule description="tipo" filter="is_selected()" key="{35c08ca5-06b4-4ca1-ba18-91a1468965cc}">
<settings calloutType="simple">
...
<Option value="11" name="Cabo (11)" type="int"/>
<Option value="4" name="Chapada (4)" type="int"/>
<Option value="5" name="Maciço (5)" type="int"/>
<Option value="3" name="Montanha (3)" type="int"/>
<Option value="2" name="Morro (2)" type="int"/>
<Option value="9" name="Península (9)" type="int"/>
<Option value="17" name="Pico (17)" type="int"/>
<Option value="6" name="Planalto (6)" type="int"/>
<Option value="7" name="Planície (7)" type="int"/>
<Option value="10" name="Ponta (10)" type="int"/>
...
<alias field="espacamento" name="" index="8"/>
