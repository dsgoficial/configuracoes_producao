...
- infra_ferrovia_l - snap - sr ok
- infra_via_deslocamento_l - snap - sr ok
...
--> Processings para area sem dados
    ...
    X 20 Identificar pontas soltas e linhas nao segmentadas  ☒
    
    IDENTIFICAR PONTAS SOLTAS ANTES DE CONSTRUIR POLIGONO
    --> 21 Identificar pontas soltas pequenas nas linhas ☑
    X 22 Identificar erros na construção das redes rodoviárias e ferroviárias ☒
    X 23 Linha para multilinha ☒
    X 24 Identificar erros de ortografia no atributo nome ☑
    X 25 Identificar erros de atributação ☑
    
    CONSTRUIR POLIGONO
    --> 26 Construir poligono area sem dados e verificar flags
...
- arquivo: /configuracoes_producao/edgv_orto/2_5/modelo_qgis/area_sem_dados/snap_hierarquico_area_sem_dados.model3
