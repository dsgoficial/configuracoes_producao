...
Os modelos aqui descritos tem por objetivo atender as subfases de Ferrovia e Via deslocamento do SAP.
...
## 4. Identificar linhas de Ferrovia entrelaçadas

- arquivo: /configuracoes_producao/edgv_orto/2_5/ferrovia/identifica_ferrovia_entrelacada.model3
...
- arquivo: /configuracoes_producao/edgv_orto/2_5/modelo_qgis/ferrovia/snap_hierarquico_ferrovia.model3
...
## 11. Identificar geometrias inválidas e ângulos pequenos entre camadas pós snap
...
- camadas linha: infra_ferrovia_l
...
- arquivo: /configuracoes_producao/edgv_orto/2_5/modelo_qgis/ferrovia/identifica_linhas_segmentadas_com_mesmo_conjunto_de_atributos_transportes.model3
...
## 21. Identificar pontas soltas e linhas não segmentadas transportes

- arquivo: /configuracoes_producao/edgv_orto/2_5/modelo_qgis/ferrovia/identificar_linhas_nao_segmentadas_nas_interseccoes_transportes.model3
- camadas: infra_ferrovia_l
- nome camada flags: flags_elem_rede_nao_segmentados

## 22. Identificar elementos pequenos na rede
- arquivo: identificar_elementos_pequenos_na_rede.model3
- camadas do pontas livre de primeira ordem: infra_ferrovia_l
- tamanho: 5 m (0.00005 grau)
- nome camada flags: flags_linhas_pequenas

## 23. Identificar erros na construção das redes de ferroviárias

- arquivo: /configuracoes_producao/edgv_orto/2_5/modelo_qgis/ferrovia/identificar_erros_rede_transporte.model3
- camadas: infra_ferrovia_l
- camadas filtro linha: infra_ferrovia_l
- black list de atributos: ["id","texto_edicao","label_x","label_y","justificativa_txt","tamanho_txt","visivel","carta_simbolizacao","simbolizar_carta_mini","simb_rot","rotular_carta_mini","espacamento","tamanho_txt","estilo_fonte","cor","cor_buffer","tamanho_buffer","observacao","length_otf", "geometry_error", "observacao", "operador_criacao", "data_criacao", "operador_atualizacao", "data_atualizacao"]
- nome camada flags: flags_redes_transporte

## 24. Linha para multilinha

- arquivo: /configuracoes_producao/edgv_orto/2_5/modelo_qgis/ferrovia/linha_para_multilinha_rodovia.model3;
- camadas: infra_ferrovia_l
