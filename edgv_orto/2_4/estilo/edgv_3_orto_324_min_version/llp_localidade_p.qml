...
<rule symbol="0" filter="&quot;tipo&quot; = 1" key="{296fd94a-7de5-4572-80fd-0fec9f113daa}" label="Cidade"/>
<rule symbol="1" filter="&quot;tipo&quot; = 2" key="{e2280dd9-c26a-45c1-992e-63516b2e09f9}" label="Cap. Estadual"/>
<rule symbol="2" filter="&quot;tipo&quot; = 3" key="{9da5bec6-4125-482c-a31b-f5f665013251}" label="Cap. Federal"/>
<rule symbol="3" filter="&quot;tipo&quot; = 4" key="{669c58e7-47c3-40f0-b3a6-918a12f4f09e}" label="Vila"/>
</rules>
<symbols>
...
<rules key="{00d2dbc7-f8de-41a2-b843-998fdb1511af}">
<rule description="nome " filter="&quot;nome&quot;" key="{67607ce9-8536-45ad-8b60-d447ba1f807e}">
...
<rule description="Tipo" filter="&quot;tipo&quot;" key="{541c5d32-2518-4142-9a31-6ee7573f09c1}">
<settings calloutType="simple">
...
<Option value="2" name="Capital estadual (2)" type="int"/>
<Option value="3" name="Capital federal (3)" type="int"/>
<Option value="1" name="Cidade (1)" type="int"/>
<Option value="4" name="Vila (4)" type="int"/>
</Option>
</Option>
</config>
</editWidget>
...
<alias field="populacao" name="" index="3"/>
...
<constraint field="populacao" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
...
<constraint field="populacao" desc="" exp=""/>
...
<fieldstyle fieldname="populacao">
<style background_color="#ff7f7f" background_color_alpha="255" rule="(tipo in (1,2,3) and (populacao is NULL)) or (not(tipo in (1,2,3)) and (not(populacao is NULL)))" name="população - Atributo incorreto (R142_V)">
<font style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
</style>
</fieldstyle>
</fieldstyles>
