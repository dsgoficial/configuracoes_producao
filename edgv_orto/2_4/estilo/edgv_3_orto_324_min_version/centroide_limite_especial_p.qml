...
<rule symbol="0" filter="tipo in (31, 26, 33, 32, 35, 34, 28, 30, 27, 29, 2, 5, 24, 25, 36)" key="{3eb748db-7ef2-443b-a876-d00c4e097066}" label="Ok"/>
<rule symbol="1" filter="ELSE" key="{73322089-852c-4b02-b201-d9f9983f766f}" label="Erro"/>
</rules>
<symbols>
...
<prop v="146,244,131,255" k="color"/>
...
<rule filter="is_selected()" key="{bdad7fc6-2f65-4584-a511-287f1fb1206c}">
...
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="PointGeometry" yOffset="-3.0000000000000009" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="1" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="1" placement="1" offsetType="0" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
...
<Option value="31" name="Estação Ecológica – ESEC (31)" type="int"/>
<Option value="26" name="Floresta – FLO (26)" type="int"/>
<Option value="33" name="Monumento Natural – MONA (33)" type="int"/>
<Option value="32" name="Parque – PAR (32)" type="int"/>
<Option value="35" name="Refúgio de Vida Silvestre – RVS (35)" type="int"/>
<Option value="34" name="Reserva Biológica – REBIO (34)" type="int"/>
<Option value="28" name="Reserva Extrativista – RESEX (28)" type="int"/>
<Option value="30" name="Reserva Particular do Patrimônio Natural – RPPN (30)" type="int"/>
<Option value="27" name="Reserva de Desenvolvimento Sustentável – RDS (27)" type="int"/>
<Option value="29" name="Reserva de Fauna – REFAU (29)" type="int"/>
<Option value="2" name="Terra indígena (2)" type="int"/>
<Option value="5" name="Unidade de Conservação (5)" type="int"/>
<Option value="24" name="Área de Proteção Ambiental – APA (24)" type="int"/>
<Option value="25" name="Área de Relevante Interesse Ecológico – ARIE (25)" type="int"/>
<Option value="36" name="Área militar (36)" type="int"/>
</Option>
</Option>
</config>
</editWidget>
...
<alias field="attribute_error_description" name="" index="9"/>
</aliases>
<defaults>
...
<constraint field="geometria_aproximada" notnull_strength="1" exp_strength="0" constraints="1" unique_strength="0"/>
...
<constraint field="geometria_aproximada" desc="" exp=""/>
...
<fieldstyle fieldname="geometria_aproximada">
<style background_color="#ffbd7f" background_color_alpha="255" rule="geometria_aproximada in (9999)" name="geometria_aproximada - Preencher atributo">
<font style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
</style>
</fieldstyle>
</fieldstyles>
