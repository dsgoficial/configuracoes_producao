...
<rule symbol="0" filter="tipo in (5, 6, 7)" key="{95168ccf-63af-4ed7-886c-669d7b531053}" label="Ok"/>
<rule symbol="1" filter="else" key="{7daacf37-2e4c-4f75-baba-655916f87fe9}" label="Erro"/>
</rules>
<symbols>
...
<Option value="250,227,78,255" name="color" type="QString"/>
...
<Option value="0,39,57,255" name="outline_color" type="QString"/>
...
<prop v="0,39,57,255" k="outline_color"/>
...
<rules key="{7aa34bbf-65e6-43c8-b942-2430cccbfc6c}">
<rule filter="tipo in(5,6,7)" key="{a84f219e-30f3-4313-a828-5bb97519a409}">
...
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="PointGeometry" yOffset="-4.9999999999999964" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="0" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="4" placement="1" offsetType="1" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
...
<rule filter="is_selected()" key="{7d3ab600-cc88-4358-8807-f806a170114e}">
<settings calloutType="simple">
...
<text-format rightDirectionSymbol=">" reverseDirectionSymbol="0" addDirectionSymbol="0" formatNumbers="0" autoWrapLength="0" leftDirectionSymbol="&lt;" multilineAlign="3" plussign="0" decimals="3" wrapChar="" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0"/>
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="PointGeometry" yOffset="4" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="0" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="7" placement="1" offsetType="1" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
<rendering minFeatureSize="0" zIndex="0" scaleMin="0" obstacleFactor="1" limitNumLabels="0" upsidedownLabels="0" maxNumLabels="2000" drawLabels="1" displayAll="0" unplacedVisibility="0" mergeLines="0" fontMinPixelSize="3" obstacleType="1" labelPerPart="0" obstacle="1" fontLimitPixelSize="0" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="0"/>
<dd_properties>
<Option type="Map">
<Option value="" name="name" type="QString"/>
...
<Option value="5" name="Aglomerado rural isolado – Núcleo (5)" type="int"/>
<Option value="6" name="Aglomerado rural isolado – Povoado (6)" type="int"/>
<Option value="7" name="Outros aglomerados rurais – Lugarejo (7)" type="int"/>
</Option>
</Option>
</config>
</editWidget>
