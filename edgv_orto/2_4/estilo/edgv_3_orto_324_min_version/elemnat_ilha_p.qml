...
<rule symbol="0" filter="tipo in (1,2,3)" key="{3b2ca20b-177a-47e3-8c79-65196866ef40}" label="Ok"/>
<rule symbol="1" filter="ELSE" key="{8d31c71a-12b3-4f32-9261-9e66ab87464a}" label="Erro"/>
</rules>
<symbols>
...
<Option value="248,124,15,255" name="color" type="QString"/>
...
<rules key="{25edf791-63fb-4455-b605-9b03110f15d4}">
<rule filter="is_selected()" key="{61319828-999a-4d9d-a041-6b2729607a54}">
...
<placement repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" distUnits="MM" priority="5" layerType="PointGeometry" yOffset="5" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" dist="0" lineAnchorType="0" offsetUnits="MM" rotationUnit="AngleDegrees" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="7" placement="1" offsetType="1" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0"/>
...
<rule filter="is_selected()" key="{09910f97-2470-45b3-90b4-acc33768390b}">
<settings calloutType="simple">
...
<Option value="1" name="Fluvial (1)" type="int"/>
<Option value="3" name="Lacustre (3)" type="int"/>
<Option value="2" name="Marítima (2)" type="int"/>
</Option>
</Option>
</config>
</editWidget>
